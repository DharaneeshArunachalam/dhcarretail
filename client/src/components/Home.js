...
export function Home() {
    ...
    const register=(event)=>{
        ...
        axios.post("http://localhost:3002/register",data,configuration)
        .then(function(res){
            if(res.data.status=="error"){
                alert("Cannot upload your datas");
            }
                        ...
                        <div className="registerForm" id="registerform" >
                            ...
                            <form onSubmit={register}>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="personName" placeholder="Enter your name" />
                                </div>
                                <div class="mb-3">
